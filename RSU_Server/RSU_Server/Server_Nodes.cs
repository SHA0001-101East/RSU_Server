...
namespace RSU_Server
{
    public class Server_Nodes
    {
        ...
        public Server_Nodes(Vector3 nodesPos1)
        {
            position = nodesPos1;
            teamDictionary.Add(Server_Game.neutralTeam, new Team(Server_Game.neutralTeam, Server_Game.defaultTroopCount));
        }
